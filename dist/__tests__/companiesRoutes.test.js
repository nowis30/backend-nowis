...
describe('Companies routes', () => {
    ...
    let otherCompanyId;
    beforeAll(async () => {
        await prisma_1.prisma.userRole.deleteMany({ where: { user: { email: { in: [email, otherEmail] } } } });
    ...
    it('gère le cycle de vie complet des entreprises et ressources associées', async () => {
        const listEmpty = await (0, supertest_1.default)(app_1.app)
            .get('/api/companies')
        ...
        const detailResponse = await (0, supertest_1.default)(app_1.app)
        ...
        const shareholdersEmpty = await (0, supertest_1.default)(app_1.app)
            .get(`/api/companies/${companyId}/shareholders`)
            .set('Authorization', `Bearer ${token}`)
            .expect(200);
        expect(shareholdersEmpty.body).toEqual([]);
        const createShareholder = await (0, supertest_1.default)(app_1.app)
        ...
        const linkId = createShareholder.body.id;
        const shareholderId = createShareholder.body.shareholder.id;
        const updateShareholder = await (0, supertest_1.default)(app_1.app)
        ...
        const refreshedDetailAfterShareholder = await (0, supertest_1.default)(app_1.app)
            .get(`/api/companies/${companyId}`)
            .set('Authorization', `Bearer ${token}`)
            .expect(200);
        ...
        const createShareClass = await (0, supertest_1.default)(app_1.app)
        ...
        const shareClassId = createShareClass.body.id;
        const updateShareClass = await (0, supertest_1.default)(app_1.app)
        ...
        const createStatement = await (0, supertest_1.default)(app_1.app)
        ...
        const statementId = createStatement.body.id;
        const updateStatement = await (0, supertest_1.default)(app_1.app)
        ...
        const createResolution = await (0, supertest_1.default)(app_1.app)
        ...
        const resolutionId = createResolution.body.id;
        const updateResolution = await (0, supertest_1.default)(app_1.app)
        ...
        const createTransaction = await (0, supertest_1.default)(app_1.app)
        ...
        const updateTransaction = await (0, supertest_1.default)(app_1.app)
        ...
        const transactionsList = await (0, supertest_1.default)(app_1.app)
        ...
        await (0, supertest_1.default)(app_1.app)
            ...
            .set('Authorization', `Bearer ${token}`)
            .expect(204);
        const listAfterDelete = await (0, supertest_1.default)(app_1.app)
            .get('/api/companies')
            .set('Authorization', `Bearer ${token}`)
            .expect(200);
